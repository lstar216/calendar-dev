  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav">
			...
			<li><a id="updateLink" href="${updateUrl}"><span class="glyphicon glyphicon-pencil"></span> 내 정보 수정</a></li>
			</sec:authorize>
			...
			<li><form id="logoutForm" action="/calendar-dev/j_spring_security_logout" method="post"></form>
			<a href="javascript:formSubmit()"><span class="glyphicon glyphicon-open"></span> 로그아웃</a></li>
			</sec:authorize>
        </ul>
    </div>
  </div>
